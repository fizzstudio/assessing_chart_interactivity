...
const index = require('./index-88c143bf.js');
const max = require('./max-345382d7.js');
const min = require('./min-58e10159.js');
const band = require('./band-85c0b2d0.js');
const linear = require('./linear-d826d881.js');
const quantize = require('./quantize-fecc50d9.js');
const visaChartsUtils_umd = require('./visa-charts-utils.umd-05af4699.js');
const index$1 = require('./index-a2abb1b5.js');
const circle = require('./circle-4a84a6a8.js');
require('./range-29edd0b2.js');
require('./value-cbed0c94.js');
...
let HeatMap = class {
  ...
  bindInteractivity() {
    ...
    this.updateLabels
      ...
      .on('mouseover', this.dataLabel.visible && !this.suppressEvents ? (d, i, n) => this.onHoverHandler(d, n[i]) : null)
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (index.h("div", { class: `o-layout` }, index.h("div", { class: "o-layout--chart" }, index.h(this.topLevel, { "data-testid": "main-title" }, this.mainTitle), index.h(this.bottomLevel, { class: "visa-ui-text--instructions", "data-testid": "sub-title" }, this.subTitle), index.h("div", { class: "heat-map-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'cell', groupName: 'row', chartTag: 'heat-map', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), index.h("div", { class: "visa-viz-d3-heat-map-container" }), index.h("div", { class: "heat-map-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton }))));
  }
  init() {
    // reading properties
