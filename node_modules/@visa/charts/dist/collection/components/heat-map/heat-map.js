  ...
  render() {
    ...
    return (h("div", { class: `o-layout` },
      h("div", { class: "o-layout--chart" },
        ...
        h("div", { class: "heat-map-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }),
        h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'cell', groupName: 'row', chartTag: 'heat-map', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
            this.accessibility.elementsAreInterface === false &&
            this.accessibility.keyboardNavConfig &&
            this.accessibility.keyboardNavConfig.disabled }),
        h("div", { class: "visa-viz-d3-heat-map-container" }),
        h("div", { class: "heat-map-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }),
