...
export class ScatterPlot {
  ...
  drawPointGroups() {
    this.updatePoints
      ...
      .ease(easeCircleIn)
      .attr('d', d => this.groupAccessor ? symbols[this.symbol(d[this.groupAccessor])].general : symbols[this.dotSymbols[0]].general)
      .attr('transform', d => 'translate(' + this.x(d[this.xAccessor]) + ',' + this.y(d[this.yAccessor]) + ') scale(' + this.dotRadius + ')')
      .call(transitionEndAll, () => {
      setTimeout(() => {
        this.updatePointWrappers
          .selectAll('.moving')
  ...
  render() {
    ...
    return (h("div", { class: "o-layout" },
      h("div", { class: "o-layout--chart" },
        h(this.topLevel, { class: "scatter-main-title vcl-main-title" }, this.mainTitle),
        h(this.bottomLevel, { class: "visa-ui-text--instructions scatter-sub-title vcl-sub-title" }, this.subTitle),
        h("div", { class: "scatter-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }),
        h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'scatter group', chartTag: 'scatter-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
            this.accessibility.elementsAreInterface === false &&
            this.accessibility.keyboardNavConfig &&
            this.accessibility.keyboardNavConfig.disabled }),
        h("div", { class: "visa-viz-d3-scatter-container" }),
        h("div", { class: "scatter-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }),
