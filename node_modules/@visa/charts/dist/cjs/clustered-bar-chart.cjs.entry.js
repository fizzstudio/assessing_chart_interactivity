...
let ClusteredBarChart = class {
  ...
  idWatcher(newID, _oldID) {
    this.chartID = newID || 'clustered-bar-chart-' + index$1.v4();
  ...
  prepareScales() {
    ...
    if (this.layout === 'vertical') {
      this.y = linear.linear()
        .domain([Math.min(0, minBarValue), this.maxValueOverride || max.max(this.data, d => d[this.valueAccessor])])
